...
class Viking extends Soldier {
  ...
  receiveDamage(patata) {
    super.receiveDamage(patata);

    if (this.health > 0) {
      return `${this.name} has received ${patata} points of damage`;
    } else {
...
class Saxon extends Soldier {
  receiveDamage(patata) {
    super.receiveDamage(patata);
    if (this.health > 0) {
      return `A Saxon has received ${patata} points of damage`;
    } else {
