...
class War {
	...
	vikingAttack() {
		let randomNumViking = Math.floor(
			Math.random() * this.vikingArmy.length
		);
		let randomNumSaxon = Math.floor(Math.random() * this.saxonArmy.length);
		let result = this.saxonArmy[randomNumSaxon].receiveDamage(
			this.vikingArmy[randomNumViking].strength
		);
	...
	saxonAttack() {
		...
		let result = this.vikingArmy[randomNumViking].receiveDamage(
			this.saxonArmy[randomNumSaxon].strength
		);
