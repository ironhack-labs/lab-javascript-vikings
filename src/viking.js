...
/*const soldier = new Soldier(20,20)
console.log(soldier)
console.log(soldier.receiveDamage(15),soldier)*/
...
/*const viking= new Viking(`gian`,20,25)
console.log(viking)
console.log(viking.receiveDamage(10),viking)*/
...
/*const saxon = new Saxon(20,25)
console.log(saxon)
console.log(saxon.receiveDamage(29),saxon)*/
