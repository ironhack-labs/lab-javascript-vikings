...
class War {
    ...
    vikingAttack(){
        ...
        let message = this.saxonArmy[randSax].receiveDamage(this.vikingArmy[randVik].strength);
    ...
    saxonAttack(){
        let randSax = Math.floor(Math.random()*this.saxonArmy.length);
        let randVik = Math.floor(Math.random()*this.vikingArmy.length);
        let message = this.vikingArmy[randVik].receiveDamage(this.saxonArmy[randSax].strength);
