...
class War {
    ...
    vikingAttack() {
      ...
      let resultOfReceiveDamage = this.saxonArmy[randomIndexSaxon].receiveDamage(this.vikingArmy[randomIndexViking].strength);
    ...
    saxonAttack() {
      let randomIndexSaxon = Math.floor(Math.random() * this.saxonArmy.length);
      let randomIndexViking = Math.floor(Math.random() * this.vikingArmy.length);
      let resultOfReceiveDamage = this.vikingArmy[randomIndexViking].receiveDamage(this.saxonArmy[randomIndexSaxon].strength);
