...
class War {
  ...
  vikingAttack() {
    ...
    let result = this.saxonArmy[randomSaxonSoldierIndex].receiveDamage(randomVikingSoldier.strength);
  ...
  saxonAttack() {
    ...
    let result = this.vikingArmy[randomVikingSoldierIndex].receiveDamage(randomSaxonSoldier.strength);
