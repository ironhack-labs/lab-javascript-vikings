...
class War {
    ...
    vikingAttack() {
        ...
        const randomSaxon = this.saxonArmy[Math.floor(Math.random() * this.vikingArmy.length)];
        const damageReceived = randomViking.strength;
        const result = randomSaxon.receiveDamage(damageReceived);
    ...
    saxonAttack() {
        ...
        const result = randomViking.receiveDamage(damageReceived);
