...
class War {
    ...
    vikingAttack() {
        ...
        let ret = this.saxonArmy[auxSax].receiveDamage(this.vikingArmy[auxVik].strength)
    ...
    saxonAttack() {
        ...
        let ret= this.vikingArmy[auxVik].receiveDamage(this.saxonArmy[auxSax].strength)
