...
class War {
  ...
  vikingAttack() {
    ...
    const atackViking = this.saxonArmy[randomNumberSaxon].receiveDamage(this.vikingArmy[randomNumberViking].attack())
  ...
  saxonAttack() {
    ...
    const atackSaxon = this.vikingArmy[randomNumberViking].receiveDamage(this.saxonArmy[randomNumberSaxon].attack())
