...
it("should receive 1 argument (the damage)", function () {
 ...
 it("should remove the received damage from the health property", function () {   soldier.receiveDamage(50);   expect(soldier.health).toEqual(health - 50);
});

it("shouldn't return anything", function () {   expect(soldier.receiveDamage(50)).toEqual(undefined); });
  });
});
...
describe("Viking", function () {
  ...
  describe("receiveDamage() method", function () {
     ...
     it("should receive 1 argument (the dage)", function () {
