  ...
  describe("receiveDamage() method", function () {
    it("should be a function", function () {
     ...
     it("should return \"NAME has received DAMAGE points of damage\", if the Viking is still alive", function () {
       expect(viking.receiveDamage(50)).toEqual(name + " has received 250 points of damage");
       expect(viking.receiveDamage(75)).toEqual(name + " has received 175 points of damage");
    });
...
describe("Saxon", function () {
  ...
  describe("receiveDamage() method", function () {
    ...
    it("should return \"A Saxon has received DAMAGE points of damage\", if the Saxon is still alive", function () {
      expect(saxon.receiveDamage(45)).toEqual("A Saxon has received 15 points of damage");
      expect(saxon.receiveDamage(10)).toEqual("A Saxon has received 5 points of damage");
     });
...
describe("War", function () {
  ...
  describe("addSaxon() method", function () {
    ...
    it("should 1 argument (a Saxon object)", function () {
