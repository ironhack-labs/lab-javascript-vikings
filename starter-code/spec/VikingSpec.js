    ...
    describe("vikingAttack() method", function () {
      ...
      it("should remove dead saxons from the army", function () {
        ...
        expect(war.saxonArmy.length).toEqual(0);
          ...
          // No funciona esta función (Viene problemática desde receiveDamage)
    //   it("should return result of calling receiveDamage() of a Saxon with the strength of a Viking", function() {        expect(war.vikingAttack()).toEqual("A Saxon has died in combat");
    //   });
    });
