...
describe("Saxon", function () {
  ...
  describe("receiveDamage() method", function () {
    ...
    //
    // it("should return \"A Saxon has died in act of combat\", if the Saxon dies", function () {
    //   expect(saxon.receiveDamage(health)).toEqual("A Saxon has died in act of combat");
    // });
  });
});
