...
class War {
    ...
    vikingAttack(){
        ...
        this.saxonArmy[randomSaxon].health <= 0 ? this.saxonArmy.splice([randomSaxon], 1) : void(0) ;
    ...
    saxonAttack(){
        ...
        this.vikingArmy[randomViking].health <= 0 ? this.vikingArmy.splice([randomViking], 1) : void(0) ;
