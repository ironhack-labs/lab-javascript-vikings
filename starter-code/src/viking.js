...
addSaxon(new Saxon(20,10));
addSaxon(new Saxon(15,10));
addSaxon(new Saxon(20,10));
addSaxon(new Saxon(25,10));

addViking(new Viking("Jerry", 30, 5));
addViking(new Viking("Phil", 20, 15));
addViking(new Viking("Eustance", 30, 7));
