...
class War {
    ...
    vikingAttack() {
        ...
        let resultAttack = randSaxon.receiveDamage(randViking.strength);
    ...
    saxonAttack() {
        ...
        let randomViking = this.vikingArmy[indViking];
        let randomSaxon = this.saxonArmy[Math.floor(Math.random() * this.saxonArmy.length)];
        let resultAttackSaxon = randomViking.receiveDamage(randomSaxon.strength);
