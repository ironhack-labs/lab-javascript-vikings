...
class War {
  ...
  vikingAttack() {
    ...
    let vAttack = this.saxonArmy[randomSaxon].receiveDamage(
  ...
  saxonAttack() {
    let randomSaxon = Math.floor(Math.random() * this.saxonArmy.length);
    let randomViking = Math.floor(Math.random() * this.vikingArmy.length);
    let sAttack = this.vikingArmy[randomViking].receiveDamage(
  ...
  someoneAttacks(attackers, attacked) {
    ...
    const resp = this.attacked[idxD].receiveDamage(
      this.attackers[idxS].strength
    );
